  ...
  constructor(props) {
    ...
    this.state = {
      ...
      questions: [
        ...
        'ЗА ЧТО ТЫ БЛАГОДАРЕН 2022 ГОДУ?',
        ...
        'РАССКАЖИ О СВОЕЙ САМОЙ БОЛЬШОЙ ПОБЕДЕ В 2022 ГОДУ',
        ...
        'КАКОЙ МЕСЯЦ БЫЛ САМЫМ СЧАСТЛИВЫМ В 2022 И ПОЧЕМУ?',
        ...
        'ЧТО ТЫ ПОДАРИШЬ СЕБЕ НА НОВЫЙ ГОД? ТВОЙ ИДЕАЛЬНЫЙ НОВОГОДНИЙ ПОДАРОК',
